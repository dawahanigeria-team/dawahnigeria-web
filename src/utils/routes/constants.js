...
export const RECENTLY_POSTED_MORE = "/dawahcast/more/recent";
export const RECENTLY_VIEWED_MORE = "/dawahcast/more/recently-viewed";
export const TRENDING_MORE = "/dawahcast/more/trending";
