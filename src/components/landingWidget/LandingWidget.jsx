...
useEffect(() => {
  ...
  return (
    <div className={`landing_album_wrapper space-y-2 ${styling ? 'h-[10.5rem] w-[9.5rem]':'h-[11.5rem] w-[10.313rem]'}`}>
      <div className="landing_album_container">
        <img src-data={img} id="song"  src={"https://imagetolink.com/ib/TnDGh8F6J0.jpeg"} alt="background" className="landing_album_background_image" />
        ...
        <div className={audioId === nid ?`landing_play_super_wrap hide`: `landing_play_super_wrap show`}>
