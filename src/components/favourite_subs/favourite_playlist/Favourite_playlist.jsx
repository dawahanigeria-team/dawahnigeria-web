...
const Favourite_playlist = ({setCount3}) => {
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  {(!currentUser?.id || myAlb?.length === 0 ) && <div className="favplaylist_img_wrap">
        ...
        className="favplaylist_button">Discover more songs</button>
                  ...
                  onClick={() => {
                    navigate(`${PLAYLISTS}${id}`, {
                      state: {
                        ...
                        audio,
                        favorites,
                        nav1:{title:'favorite playlist', link:'/favorite'}
                      },
                    });
                  }}
                  key={idx + 1}
                >
                  <AlbumWidget key={idx} views={views || 0} categories={categories} img={img} />
                </div>
              );
            }
            else {
                  ...
                  onClick={() => {
                    navigate(`${PLAYLISTS}${id}`, {
                      state: {
                        ...
                        favorites,
                        views,
                        nav1:{title:'favourite playlist', link:'/favorite'}
                      },
                    });
                  }}
                  key={idx + 1}
