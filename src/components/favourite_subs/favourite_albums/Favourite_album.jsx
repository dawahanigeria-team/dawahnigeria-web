...
const Favourite_album = ({setCount2}) => {
 ...
 // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  return (
    ...
    {(!currentUser?.id || myAlb?.length === 0 ) && <div className="favalbum_img_wrap">
        ...
        className="favalbum_button">Discover more Albums</button>
    ...
    { myAlb?.length !== 0 && <div className="favalb_wrapper">
        {!loading && data.map(
          (
            {
              categories,
