  ...
  return (
    <Container>
      <div className="video_wrapper">
        ...
        {loading && <div className="w-full flex items-center justify-center h-[300px]">
          <Loader/>
          </div>}
        {!loading && <div className="video_widget">
          {data.map(({ images,id, favourites, author, views, title, duration }, idx) => {
