 ...
 * Flow:
 * 1. Read `reference` from URL query params
...
const PaystackCallback = () => {
  ...
  const handleVerification = useCallback(async () => {
    ...
    try {
      ...
      const verifyResult = await verifySubscription(paymentReference);
  ...
  }, [searchParams, isLoggedIn, verifySubscription, refreshFeatures, navigate]);
