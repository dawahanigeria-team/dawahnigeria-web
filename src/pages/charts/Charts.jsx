...
const Charts = () => {
  ...
  useEffect(() => {
    ...
    //weekly lectures
    axios
      .get("/leclisting_charts_api.php?action=weekly")
      .then((res) => {
    ...
    //monthly lectures
    axios
      .get("/leclisting_charts_api.php?action=monthly")
      .then((res) => {
        //console.log(res.data)
        const { data } = res.data;
    ...
    // daily album
    axios
      .get("/albumlisting_charts_api.php?action=daily")
      .then((res) => {
        //console.log(res.data)
        const { data } = res.data;
        setdailyAlbum(data);
    ...
    // weekly album
    axios
      .get("/albumlisting_charts_api.php?action=weekly")
      .then((res) => {
        const { data } = res.data;
        setweeklyAlbum(data);
      })
    ...
    //monthly album
    axios
      .get("/albumlisting_charts_api.php?action=monthly")
      .then((res) => {
        const { data } = res.data;
    ...
    //daily lecturers
    axios
      .get("/rplisting_charts_api.php?action=daily")
      .then((res) => {
        const { data } = res.data;
    ...
    //weekly lecturers
    axios
      .get("/rplisting_charts_api.php?action=weekly")
      .then((res) => {
        const { data } = res.data;
    ...
    //monthly lecturers
    axios
      .get("/rplisting_charts_api.php?action=monthly")
      .then((res) => {
        const { data } = res.data;
    ...
    //daily plalist
    axios
      .get("/playlist_charts_api.php?action=daily")
      .then((res) => {
        //console.log(res.data)
        const { data } = res.data;
    ...
    //weekly playlist
    axios
      .get("/playlist_charts_api.php?action=weekly")
      .then((res) => {
        const { data } = res.data;
    ...
    //monthly playlist
    axios
      .get("/playlist_charts_api.php?action=monthly")
      .then((res) => {
        const { data } = res.data;
